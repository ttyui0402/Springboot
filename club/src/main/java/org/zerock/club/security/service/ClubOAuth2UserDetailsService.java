...
//      return oAuth2User;
    ...
    private ClubMember saveSocialMember(String email) {
        ...
        // 없다면 회원 추가 패스워드는 1111 이름은 그냥 이메일 주소로 한다.
        ClubMember clubMember = ClubMember.builder().email(email).name(email).password(passwordEncoder.encode("1111")).fromSocial(true).build();
